...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-bedr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7497&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-bedr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-bedr` can be installed with:

```
conda install r-bedr
```

It is possible to list all of the versions of `r-bedr` available on your platform with:
